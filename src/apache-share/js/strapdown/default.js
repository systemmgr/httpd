      ...
      return (
        ...
        (i.blockTokens = function (e, t, n) {
          ...
          for (
            ...
            for (
              e = e.substring(r.raw.length), s = r.items.length, i = 0; i < s; i++
            )
            ...
            switch ((s = e[a]).type) {
              ...
              case "table":
                ...
                for (r = s.cells.length, t = 0; t < r; t++)
                  for (
                    i = s.cells[t], s.tokens.cells[t] = [], n = 0; n < i.length; n++
                  )
                    (s.tokens.cells[t][n] = []),
            ...
            switch ((u = e[w]).type) {
              ...
              case "table":
                ...
                for (
                  ...
                  for (
                    a = "", s = (l = u.tokens.cells[n]).length, r = 0; r < s; r++
                  )
              ...
              case "text":
                for (
                  c = u.tokens ? this.parseInline(u.tokens) : u.text; w + 1 < v && "text" === e[w + 1].type;
